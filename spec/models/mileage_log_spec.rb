...
RSpec.describe MileageLog, type: :model do
  ...
  it "is invalid with an hours value less than 0" do
    ...
    expect(mileage_without_valid_hours.errors[:hours]).to include("debe ser mayor que o igual a 0")
  end

  it "is invalid without a machine" do
    mileage_without_machine.valid?
    expect(mileage_without_machine.errors[:machine]).to include("debe existir")
  end  
