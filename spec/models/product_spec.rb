...
RSpec.describe Product, type: :model do
  ...
  let(:product_without_specifications) { build :product, specifications: nil }
  ...
  it "is invalid without specifications" do
    product_without_specifications.valid?
    expect(product_without_specifications.errors[:specifications]).to include("no puede estar en blanco")
  end
